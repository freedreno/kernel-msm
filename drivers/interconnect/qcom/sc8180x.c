...
DEFINE_QNODE(mas_qnm_mnoc_hf_display, SC8180X_MASTER_MNOC_HF_MEM_NOC_DISPLAY, 2, 32, SC8180X_SLAVE_LLCC_DISPLAY);
DEFINE_QNODE(mas_qnm_mnoc_sf_display, SC8180X_MASTER_MNOC_SF_MEM_NOC_DISPLAY, 1, 32, SC8180X_SLAVE_LLCC_DISPLAY);
DEFINE_QNODE(mas_llcc_mc_display, SC8180X_MASTER_LLCC_DISPLAY, 8, 4, SC8180X_SLAVE_EBI_CH0_DISPLAY);
DEFINE_QNODE(mas_qxm_mdp0_display, SC8180X_MASTER_MDP_PORT0_DISPLAY, 1, 32, SC8180X_SLAVE_MNOC_HF_MEM_NOC_DISPLAY);
DEFINE_QNODE(mas_qxm_mdp1_display, SC8180X_MASTER_MDP_PORT1_DISPLAY, 1, 32, SC8180X_SLAVE_MNOC_HF_MEM_NOC_DISPLAY);
DEFINE_QNODE(mas_qxm_rot_display, SC8180X_MASTER_ROTATOR_DISPLAY, 1, 32, SC8180X_SLAVE_MNOC_SF_MEM_NOC_DISPLAY);
...
DEFINE_QNODE(slv_qns_llcc_display, SC8180X_SLAVE_LLCC_DISPLAY, 8, 16, SC8180X_MASTER_LLCC_DISPLAY);
DEFINE_QNODE(slv_ebi_display, SC8180X_SLAVE_EBI_CH0_DISPLAY, 8, 4);
DEFINE_QNODE(slv_qns2_mem_noc_display, SC8180X_SLAVE_MNOC_SF_MEM_NOC_DISPLAY, 1, 32, SC8180X_MASTER_MNOC_SF_MEM_NOC_DISPLAY);
DEFINE_QNODE(slv_qns_mem_noc_hf_display, SC8180X_SLAVE_MNOC_HF_MEM_NOC_DISPLAY, 2, 32, SC8180X_MASTER_MNOC_HF_MEM_NOC_DISPLAY);
...
DEFINE_QBCM(bcm_acv_display, "ACV", false, &slv_ebi_display);
DEFINE_QBCM(bcm_mc0_display, "MC0", false, &slv_ebi_display);
DEFINE_QBCM(bcm_sh0_display, "SH0", false, &slv_qns_llcc_display);
DEFINE_QBCM(bcm_mm0_display, "MM0", false, &slv_qns_mem_noc_hf_display);
DEFINE_QBCM(bcm_mm1_display, "MM1", false, &mas_qxm_mdp0_display, &mas_qxm_mdp1_display);
DEFINE_QBCM(bcm_mm2_display, "MM2", false, &mas_qxm_rot_display, &slv_qns2_mem_noc_display);
...
static struct qcom_icc_node *system_noc_nodes[] = {
	...
	[SLAVE_PCIE_0] = &slv_qhs_pcie0_cfg,
	[SLAVE_PCIE_1] = &slv_qhs_pcie1_cfg,
	[SLAVE_PCIE_2] = &slv_qhs_pcie2_cfg,
	[SLAVE_PCIE_3] = &slv_qhs_pcie3_cfg,
	[SLAVE_QDSS_STM] = &slv_xs_qdss_stm,
	[SLAVE_TCU] = &slv_xs_sys_tcu_cfg,
};

static struct qcom_icc_node *gem_noc_display_nodes[] = {
	[MASTER_MNOC_HF_MEM_NOC_DISPLAY] = &mas_qnm_mnoc_hf_display,
	[MASTER_MNOC_SF_MEM_NOC_DISPLAY] = &mas_qnm_mnoc_sf_display,
	[SLAVE_LLCC_DISPLAY] = &slv_qns_llcc_display,
};

static struct qcom_icc_node *mc_virt_display_nodes[] = {
	[MASTER_LLCC_DISPLAY] = &mas_llcc_mc_display,
	[SLAVE_EBI_CH0_DISPLAY] = &slv_ebi_display,
};

static struct qcom_icc_node *mmss_noc_display_nodes[] = {
	[MASTER_MDP_PORT0_DISPLAY] = &mas_qxm_mdp0_display,
	[MASTER_MDP_PORT1_DISPLAY] = &mas_qxm_mdp1_display,
	[MASTER_ROTATOR_DISPLAY] = &mas_qxm_rot_display,
	[SLAVE_MNOC_SF_MEM_NOC_DISPLAY] = &slv_qns2_mem_noc_display,
	[SLAVE_MNOC_HF_MEM_NOC_DISPLAY] = &slv_qns_mem_noc_hf_display,
};
...
static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,sc8180x-aggre1-noc", .data = &aggre1_noc_nodes },
	{ .compatible = "qcom,sc8180x-aggre2-noc", .data = &aggre2_noc_nodes },
	{ .compatible = "qcom,sc8180x-camnoc-virt", .data = &camnoc_virt_nodes },
	{ .compatible = "qcom,sc8180x-compute-noc", .data = &compute_noc_nodes },
	{ .compatible = "qcom,sc8180x-config-noc", .data = &config_noc_nodes },
	{ .compatible = "qcom,sc8180x-dc-noc", .data = &dc_noc_nodes },
	{ .compatible = "qcom,sc8180x-gem-noc", .data = &gem_noc_nodes },
	{ .compatible = "qcom,sc8180x-ipa-virt", .data = &ipa_virt_nodes },
	{ .compatible = "qcom,sc8180x-mc-virt", .data = &mc_virt_nodes },
	{ .compatible = "qcom,sc8180x-mmss-noc", .data = &mmss_noc_nodes },
	{ .compatible = "qcom,sc8180x-system-noc", .data = &system_noc_nodes },
	{ }
};
